...
async function createCardImage(randomIdCard, filedSide){
    ...
    if(filedSide === playerSides.player1){
...
async function setCardsField(cardId){
    ...
    state.fieldCards.computer.src = cardData[computerCardId].img; // ✅ agora diferente

    let duelResults = await checkDuelResults(cardId, computerCardId); // ✅ corrigido
